...
print(dataset)
features_train, features_test, target_train, target_test = train_test_split(dataset, target, test_size=0.2)
sc = StandardScaler()
...
ppn = Perceptron(alpha=0.00001, class_weight=None, eta0=0.15, fit_intercept=True,
      max_iter=60,  n_jobs=1, penalty=None, random_state=0,
